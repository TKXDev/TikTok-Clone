<template>
  <div
    id="TopNav"
    class="fixed z-[300] bg-white flex items-center w-full border-b h-[61px]"
  >
    <div
      :class="route.fullPath === '/' ? 'max-w-[1150px]' : ''"
      class="flex items-center justify-center w-full px-6 mx-auto"
    >
      ...
      >
        ...
        <div class="px-3 py-1 flex items-center border-l border-l-gray-300">
          <Icon name="ic:baseline-search" color="#a1a2a7" size="22" />
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          <Icon name="ic:baseline-add" color="#000000" size="22" />
